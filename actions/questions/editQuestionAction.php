...
if(isset($_POST['validate'])){
    ...
    if(!empty($_POST['title']) AND !empty($_POST['description'])){
        ...
        $editQuestionOnWebsite = $bdd->prepare('UPDATE questions SET titre = ?, description = ? WHERE id = ?');
        $editQuestionOnWebsite->execute(array($new_question_title, $new_question_description, $idOfQuestion));
